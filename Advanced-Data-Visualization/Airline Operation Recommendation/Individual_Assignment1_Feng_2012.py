...
# The following line of code is used to extract data for 2012 by selecting all records of 2012 (the minimum value of year)
p = df[df['year']== df['year'].min()].squeeze()
p
...
# The following codes are used for creating a multiple-line chart of four major U.S. cities'temperature values in 2012
...
plt.legend()
plt.title('U.S. Cities Weather in 2012')
plt.xlabel('Days')
...
# The following codes are used for extracting only 2012 data from the indexed dataset
z = df_ct[df_ct['year']== df_ct['year'].min()].squeeze()
z
...
# The following codes are used for creating a multiple-line index chart of four major U.S. cities'temperature values in 2012
