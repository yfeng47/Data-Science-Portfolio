...
def make_interpreter(model_file):
  ...
  return tflite.Interpreter(
      ...
      experimental_delegates=[tflite.load_delegate('/Users/joshua/edgetpu_runtime/libedgetpu/direct/darwin/libedgetpu.1.dylib')])
...
def main():
  ...
  for klass in classes:
    ...
    classres = '%s: %.5f' % (labels.get(klass.id, klass.id), klass.score)

  #from PIL import Image
  #im = Image.open(r"images/Rose.jpeg")
  #im.show()
  from PIL import ImageFont
  from PIL import ImageDraw
  #img = Image.open(r"images/Rose.jpeg")
  img = Image.open(args.input)
  draw = ImageDraw.Draw(img)
  #font = ImageFont.truetype(r'filepath\..\sans-serif.ttf', 16)
  font = ImageFont.truetype('/Library/Fonts/Arial.ttf', 25)
  draw.text((3, 6),classres,(255,255,0),font=font) # this will draw text with Blackcolor and 16 size
  img.save('images/Rose2.jpeg')
  im = Image.open(r"images/Rose2.jpeg")
  im.show()
